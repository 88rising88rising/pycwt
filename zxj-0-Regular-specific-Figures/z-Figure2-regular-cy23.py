...
timeY23BM = timeY[0:65]
timeY23AM = timeY[65:150]
timeY24BM = timeY[150:214]
timeY24AM = timeY[214::]

timeM23BM = timeM[0:65]
timeM23AM = timeM[65:150]
timeM24BM = timeM[150:214]
timeM24AM = timeM[214::]
...
ax2.text(ax2lim1+(ax2lim2-ax2lim1)/25, ay2lim2-(ay2lim2-ay2lim1)/16.0, "After November 2001", fontsize = 10, va='center', rotation=0)

plt.savefig('z-Figure2-regular-cy23.eps', format='eps',dpi=1000)
plt.savefig('z-Figure2-regular-cy23.png', format='png',dpi=1000)
plt.show()
