...
timeY6090 = [float(l.split()[0]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NHSH-cy24.txt")]
timeM6090 = [float(l.split()[1]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NHSH-cy24.txt")]
timeYM6090 = [float(l.split()[2]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NHSH-cy24.txt")]
caa_absH = [float(l.split()[-2]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NHSH-cy24.txt")]
caa_norH = [float(l.split()[-1]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NHSH-cy24.txt")]

timeY1040 = [float(l.split()[0]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NLSL-cy24.txt")]
timeM1040 = [float(l.split()[1]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NLSL-cy24.txt")]
timeYM1040 = [float(l.split()[2]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NLSL-cy24.txt")]
caa_absL = [float(l.split()[-2]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NLSL-cy24.txt")]
caa_norL = [float(l.split()[-1]) for l in open("step8-2-regular-Month-1-caa-Asymmetry-NLSL-cy24.txt")]
...
ax1.plot([S_absHTYM[-1],N_absHTYM[0]],[S_absH[-1],N_absH[0]],color='r',linewidth=1.5)
ax1.plot(S_absHTYM,S_absH,color='b',linewidth=1.5)
ax1.plot([2014.333,2014.333],[-200.0,1200.0],"gray",lw=1.0,linestyle="--")
ax1.plot([2009.0,2020.0],[0.0,0.0],color="dimgray",alpha=0.45,lw=1.0,linestyle="-")
ax1lim1 = 2009.0
ax1lim2 = 2020.0
ay1lim1 = -5.
ay1lim2 = 165
...
ax2.plot(S_absLTYM,S_absL,color='b',linewidth=1.5)
...
plt.savefig('z-Figure7-regular-cy24.eps', format='eps',dpi=1000)
plt.savefig('z-Figure7-regular-cy24.png', format='png',dpi=1000)
plt.show()
