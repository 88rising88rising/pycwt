...
timeYM6090 = [float(l.split()[2]) for l in open("step7-1-specific-Month-2caa-NHSH6090-cy23.txt")]
caaNH6090 = [float(l.split()[-2]) for l in open("step7-1-specific-Month-2caa-NHSH6090-cy23.txt")]
caaSH6090 = [float(l.split()[-1]) for l in open("step7-1-specific-Month-2caa-NHSH6090-cy23.txt")]

timeYM1040 = [float(l.split()[2]) for l in open("step7-1-specific-Month-2caa-NLSL1040-cy23.txt")]
caaNL1040 = [float(l.split()[-2]) for l in open("step7-1-specific-Month-2caa-NLSL1040-cy23.txt")]
caaSL1040 = [float(l.split()[-1]) for l in open("step7-1-specific-Month-2caa-NLSL1040-cy23.txt")]
...
ax1.text(2004.4,150.0, " April 2004", fontsize=10, color='dimgray',va='center',rotation=0)
...
ax2.text(2005.6,680.0, " September 2005", fontsize=10, color='dimgray',va='center',rotation=0)
#自定义label的位置
...
ax2.yaxis.set_minor_locator(ticker.MultipleLocator(125))
...
plt.savefig('./z-Figure4-specific-cy23.eps', format='eps',dpi=1000)
plt.savefig('./z-Figure4-specific-cy23.png', format='png',dpi=1000)
plt.show()
