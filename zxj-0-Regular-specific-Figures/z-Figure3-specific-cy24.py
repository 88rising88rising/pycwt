...
time6090Y = [float(l.split()[0]) for l in open("step5-1-specific-Month-4Asymmetry-NHSH6090.txt")]
time6090M = [float(l.split()[1]) for l in open("step5-1-specific-Month-4Asymmetry-NHSH6090.txt")]
...
time1040Y = [float(l.split()[0]) for l in open("step5-1-specific-Month-4Asymmetry-NLSL1040.txt")]
time1040M = [float(l.split()[1]) for l in open("step5-1-specific-Month-4Asymmetry-NLSL1040.txt")]
...
time6090Y23BM = time6090Y[0:66]
time6090Y23AM = time6090Y[66:151]
time6090Y24BM = time6090Y[151:215]
time6090Y24AM = time6090Y[215::]

time6090M23BM = time6090M[0:66]
time6090M23AM = time6090M[66:151]
time6090M24BM = time6090M[151:215]
time6090M24AM = time6090M[215::]
...
time1040Y23BM = time1040Y[0:66]
time1040Y23AM = time1040Y[66:151]
time1040Y24BM = time1040Y[151:215]
time1040Y24AM = time1040Y[215::]

time1040M23BM = time1040M[0:66]
time1040M23AM = time1040M[66:151]
time1040M24BM = time1040M[151:215]
time1040M24AM = time1040M[215::]
...
plt.savefig('z-Figure3-specific-cy24.eps', format='eps',dpi=1000)
plt.savefig('z-Figure3-specific-cy24.png', format='png',dpi=1000)
plt.show()
