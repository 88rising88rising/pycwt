...
timeYM6090 = [float(l.split()[2]) for l in open("step7-2-regular-Month-2caa-NHSH6090-cy24.txt")]
caaNH6090 = [float(l.split()[-2]) for l in open("step7-2-regular-Month-2caa-NHSH6090-cy24.txt")]
caaSH6090 = [float(l.split()[-1]) for l in open("step7-2-regular-Month-2caa-NHSH6090-cy24.txt")]

timeYM1040 = [float(l.split()[2]) for l in open("step7-2-regular-Month-2caa-NLSL1040-cy24.txt")]
caaNL1040 = [float(l.split()[-2]) for l in open("step7-2-regular-Month-2caa-NLSL1040-cy24.txt")]
caaSL1040 = [float(l.split()[-1]) for l in open("step7-2-regular-Month-2caa-NLSL1040-cy24.txt")]
...
#ax1.plot([2009.0,2022.0],[400.0,400.0],"grey",alpha=0.25,lw=1.0,linestyle=":")
#ax1.plot([2009.0,2022.0],[800.0,800.0],"grey",alpha=0.25,lw=1.0,linestyle=":")
#ax1.plot([2009.0,2022.0],[1200.0,1200.0],"grey",alpha=0.25,lw=1.0,linestyle=":")
#ax1.plot([2009.0,2022.0],[1600.0,1600.0],"grey",alpha=0.25,lw=1.0,linestyle=":")
#ax1.plot([2010.0,2010.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
#ax1.plot([2012.0,2012.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
#ax1.plot([2014.0,2014.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
#ax1.plot([2016.0,2016.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
#ax1.plot([2018.0,2018.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
...
#ax2.plot([2009.0,2022.0],[1000.0,1000.0],"grey",alpha=0.25,lw=1.0,linestyle=":")
#ax2.plot([2009.0,2022.0],[2000.0,2000.0],"grey",alpha=0.25,lw=1.0,linestyle=":")
#ax2.plot([2009.0,2022.0],[3000.0,3000.0],"grey",alpha=0.25,lw=1.0,linestyle=":")
#ax2.plot([2009.0,2022.0],[4000.0,4000.0],"grey",alpha=0.25,lw=1.0,linestyle=":")
#ax2.plot([2010.0,2010.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
#ax2.plot([2012.0,2012.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
#ax2.plot([2014.0,2014.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
#ax2.plot([2016.0,2016.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
#ax2.plot([2018.0,2018.0],[0.0,5000.0],"grey",alpha=0.20,lw=1.0,linestyle=":")
...
plt.savefig('./z-Figure6-regular-cy24.eps', format='eps',dpi=1000)
plt.savefig('./z-Figure6-regular-cy24.png', format='png',dpi=1000)
plt.show()
